...
/*! @discussion This method gets called when a resolve request successfully 
 completes on the server. The results of the request are passed to the caller
 in as a FactualResolveResult object.
...
/*! @discussion This method gets called when a facet query request successfully 
 ...
 @param result The FactualFacetResponse result object
 */
